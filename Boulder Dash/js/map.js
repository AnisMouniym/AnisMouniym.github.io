...
function chargerFichierTexte() {
  if (Niveau==1){
    ...
    MTTTTTTTTTTTRMTTTTTTTTTTTTTTTTTM
    MPTTTTTTRTTTDTTTTTTTTTRTTTTMTTTM
    MTTTTVTTTDTTVTTTTTTTTTTTTDTTTTTM
    MTTTTTTTRTTTTTTTTTTVTTTRTTTTTTTM
    MTTTTTTTTTTTVTTTTTTTTTTTTTTTMTTM
    ...
    MTTTTTTTTTTTTTTTTTTTTTTTTTRTTTTM
    MTTTTTTTTTRTTTTTTVTTTTTTTTTTTTTM
    MTTTTTTMTTTTTDTTTTTTTRTTTTTTTTTM
    MTTTTTTTRTTTTTTMTTTTTDTTTTTRTTTM
    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM`
  }
  else if (Niveau==2){
    text=`MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
    MPTTTVTTTDTTVTTTTTTTTTTTTDTTTTTM
    MTTTTTTTRTTTTTTTTTTVTTTRTTTTTTTM
    ...
    MTTPMTTTRTTTDTTTTTTTTTRTTTTVTTTM
    MTTRTTTTTDTTVTTTTTTTTTTTTDTTTTTM
    MTTTTTMTRTTTTTTTTTTVTTTRTTTTTTTM
    MTTTVVRTTTTTVTTTTTTTTTTTTTTTVTTM
    MTTRVVMTVTTTTTTTTTTTTTDTTTTTTTTM
    MTTTTTTTRTTTTTTTVTTTRTTTTTTTTTTM
    MTTTTTDTTTTTTTRTTTTTTTTTTDTTTTTM
    MTTTTTTTTVTTTTTTTTTTVTTTTTTTTTTM
    MTTTTRTTTTTTTDTTTRTTTTDTTTTTTTTM
    MTTVTTTTTTTTTTTTTTTTTTTTTTVTTTTM
    MTTTTTTTTTRTTTTTTVTTTTTTTTTTTTTM
    MTTDTTTVTTTTTDTTTTTTTRTTTTTTDTTM
    MTTTTTTTRTTTTTTVTTTTTDTTTTTVTTTM
    MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM`
  }
  else if (Niveau==4){
